                  ...
                  <div className="container-fluid">
                        <div id="main" className="row">
                              <div id="main-sidebar" className="col-md-auto">
                               <ul id="ul">
                                    <li id="mouse-over"><Link to="/">Take the tour</Link></li>
                                    <li id="mouse-over"><Link to="/help/guidelines">Community guidelines</Link></li>
                                    <li id="mouse-over"><Link to="/jobs">Jobs</Link></li>
                              </ul> 
                              <p id="signup-block">
                                        <Link to="/sign-up" ><img src="https://combo.staticflickr.com/pw/images/tour/en-us/create-account-button.png" width="193" height="39" alt="Create Account"/></Link>
                                      <li id="mouse-over"><Link to="/login">or Sign In</Link> </li>
                                        </p> 
                              <h3>Need help?</h3>
                              <p id="mouse-over">
                                    <Link to="/help">Visit our FAQ</Link><br/>
                                    <Link to="/help">Get help by email</Link>
                              </p>  
                              </div>
                              ...
                              <p id="mouse-over">Flickr continues to evolve in myriad ways, all of which are designed to make it easier and better. Check out the <Link to="/">Flickr Blog</Link> to stay apprised of the latest developments. The fact that you've read to the end of this entire document and are hanging out at the bottom of this page with nothing but this silly text to keep you company is proof of a deep and abiding interest on your part. What are you waiting for?
                                    <Link to="/sign-up"><b>Sign up now!</b></Link>
                              </p>
