...
import UserlessNavigationBar from './UserlessNavigationBar';
...
describe('<UserAbout />', () => {
    ...
    it('should render logged in user', () => {
        let wrapper = mount(<UserlessNavigationBar />);
        let element = wrapper.find("#log-in");
        expect(element).toHaveLength(0);
    });

    it('should render not logged in user', () => {
