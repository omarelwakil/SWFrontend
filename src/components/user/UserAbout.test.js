...
describe('<UserAbout />', () => {
    ...
    it('should render same logged in user', () => {
        let wrapper = mount(<UserAbout userInfo="60b7e086e2660c0012988e44" />);
        let element = wrapper.find("#showcase-modal");
        expect(element).toHaveLength(1);
    });

    it('should render different user', () => {
        let wrapper = mount(<UserAbout userInfo="60b7df35f8941e0012b98eec" />);
        let element = wrapper.find("#showcase-modal");
